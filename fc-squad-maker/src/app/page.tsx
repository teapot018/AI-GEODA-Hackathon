...
const FEATURES = [
  ...
  },
  {
    ...
    points: ['초성 검색 (ㅅㅎㅁ → 손흥민)', '실제 경기 스쿼드 가져오기', '+1~+13 강화 곡선'],
  },
  {
    href: '/market',
    icon: LineChart,
    title: '거래 관측소',
    description:
      'Open API 로 조회 가능한 거래 기록을 과거까지 모아 카드별 가격대·변동폭·추세를 관측합니다. 시장 전수가 아닌 표본이며, 크롤링 없이 공식 API 만 씁니다.',
    points: ['거래 관측 기반 가격 지수', '강화 등급별 가격 분리', '입력가 싸다/비싸다 판정'],
  },
  {
    href: '/trade',
    icon: Calculator,
  ...
  },
  {
    ...
    points: ['확률·기대값 사전 공개', '천장(모의 규칙) 지원', '시드로 결과 재현'],
  },
];
